...
document.getElementById('piImage').addEventListener('click', function () {
  window.location.href = "./pythonInterpreter.html";
});

document.getElementById('ghImage').addEventListener('click', function () {
  window.location.href = "https://github.com/berkay-yalin";
});
