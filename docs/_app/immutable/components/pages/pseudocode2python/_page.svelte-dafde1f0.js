import{S as q,i as Z,s as I,k as b,q as E,a as C,l as $,m as P,r as B,h as p,c as T,n as d,b as S,G as h,P as X,B as R,Q as pe,U as he,I as F,u as me,w as z,e as N,x as H,y as W,g as ge,t as Q,d as ye,f as j,z as K,H as ee,J as _e,T as be,o as $e}from"../../../chunks/index-4bdcb4d1.js";import{w as ae}from"../../../chunks/index-6fdeac39.js";const L=ae(!1),ve=ae(`// 2020 Sample assessment materials J277/02
...
next i`;alert(o),console.log("hello"),ne=!0}}function Fe(n,e){for(let s=e;s<l.length;s++){let[i,o,a,c]=[l.indexOf(l[s]),...l[s]];if(o=="pseudo"&&a==n&&c=="endwhile"){l[i]=["python",n,"REMOVED"];break}}let r=l[e][2],t=r.match(/^while(.*?)$/)[1].trim();t.endsWith(":")?r=`while ${t}`:r=`while ${t}:`,l[e]=["python",n,r]}function ze(n,e){for(let r=e;r<l.length;r++){let[t,s,i,o]=[l.indexOf(l[r]),...l[r]];if(s=="pseudo"&&i==n&&/^until(.*?)$/.test(o)){l[t]=["python",n,"REMOVED"],l[e]=["python",n,"while True:"];let c=o.match(/^until(.*?)$/)[1].trim();l.splice(t,0,["python",n+4,"break"]),l.splice(t,0,["python",n+2,`if ${c}:`]),l.splice(t,0,["python",n+2,""]);break}}}function He(n,e){for(let t=e;t<l.length;t++){let[s,i,o,a]=[l.indexOf(l[t]),...l[t]];const c=i=="pseudo"&&o==n;if(c&&a.match(/^elseif(.*?)then$/)){let f=a.match(/^elseif(.*?)then$/)[1].trim();l[s]=["python",n,`elif ${f}:`]}else if(c&&(a=="else"||a=="else:"))l[s]=["python",n,"else:"];else if(c&&a==="endif"){l[s]=["python",n,"REMOVED"];break}}let r=l[e][2];if(/^if(.*?)then$/.test(r))r=`if ${r.match(/^if(.*?)then$/)[1].trim()}:`;else if(/^if(.*?)$/.test(r)){let t=r.match(/^if(.*?)$/)[1].trim();t.endsWith(":")?r=`if ${t}`:r=`if ${t}:`}l[e]=["python",n,r]}function We(n,e){for(let t=e;t<l.length;t++){let[s,i,o,a]=[l.indexOf(l[t]),...l[t]];if(i=="pseudo"&&o==n&&a=="endprocedure"){l[s]=["python",n,"REMOVED"];break}}let r=l[e][2].match(/^procedure(.*)$/)[1].trim();l[e]=["python",n,`def ${r}:`]}function Ke(n,e){for(let t=e;t<l.length;t++){let[s,i,o,a]=[l.indexOf(l[t]),...l[t]];if(i=="pseudo"&&o==n&&a=="endfunction"){l[s]=["python",n,"REMOVED"];break}}let r=l[e][2].match(/^function(.*)$/)[1].trim();l[e]=["python",n,`def ${r}:`]}function Ye(n){l=n,re=!1,ne=!1;for(let e=0;e<l.length;e++){let[r,t,s,i]=[l.indexOf(l[e]),...l[e]];t=="pseudo"&&i!=""&&i!="REMOVED"&&(l[r][2]=ce(l[r][2]),l[r][2]=J(l[r][2]),l[r][2]=Qe(l[r][2]),l[r][2]=te(l[r][2]),l[r][2]=U(l[r][2]),l[r][2]=je(l[r][2]),l[r][2]=ue(l[r][2]),l[r][2]=Je(l[r][2]),/^for(.*?)$/.test(l[r][2])?Ue(s,r):/^while(.*?)$/.test(l[r][2])?Fe(s,r):/^do(.*?)$/.test(l[r][2])?ze(s,r):/^if(.*?)$/.test(l[r][2])?He(s,r):/^procedure(.*?)$/.test(i)?We(s,r):/^function(.*?)$/.test(i)&&Ke(s,r))}return re==!0&&(l.unshift(["python",0,""]),l.unshift(["python",0,"from random import randint"])),ne==!0?0:l.filter(e=>e[2]!="REMOVED")}let l=null,re=!1,ne=!1;function Le(n){let e,r,t,s,i,o,a,c,f,u,v,m,w,x,G,A,V,k,_,y;return u=new Oe({}),u.$on("vPPP",n[0]),u.$on("vPG",n[1]),u.$on("cPTP",n[2]),w=new Ae({}),_=new Be({}),{c(){e=b("style"),r=E(`@font-face {\r
  ...
  `),t=b("script"),i=b("script"),a=b("script"),f=C(),z(u.$$.fragment),v=C(),m=b("main"),z(w.$$.fragment),x=C(),G=b("div"),A=C(),V=b("div"),k=C(),z(_.$$.fragment),this.h()},l(g){const O=be("svelte-1hctcm2",document.head);e=$(O,"STYLE",{});var Y=P(e);r=B(Y,`@font-face {\r
      font-family: 'cabin';\r
      src: url("./Cabin-VariableFont_wdth,wght.ttf");\r
    }\r
    ::-webkit-scrollbar             { height: 0.2rem; width: 0.2rem  }\r
    ...
    ::-webkit-scrollbar-thumb       { background: rgb(136, 136, 136) }\r
    ::-webkit-scrollbar-thumb:hover { background: rgb(85, 85, 85)    }\r
  `),Y.forEach(p),t=$(O,"SCRIPT",{src:!0,integrity:!0,crossorigin:!0,referrerpolicy:!0});var D=P(t);D.forEach(p),i=$(O,"SCRIPT",{src:!0,integrity:!0,crossorigin:!0,referrerpolicy:!0});var de=P(i);de.forEach(p),a=$(O,"SCRIPT",{src:!0,integrity:!0,crossorigin:!0,referrerpolicy:!0});var fe=P(a);fe.forEach(p),O.forEach(p),f=T(g),H(u.$$.fragment,g),v=T(g),m=$(g,"MAIN",{class:!0});var M=P(m);H(w.$$.fragment,M),x=T(M),G=$(M,"DIV",{id:!0,class:!0}),P(G).forEach(p),A=T(M),V=$(M,"DIV",{id:!0,class:!0}),P(V).forEach(p),k=T(M),H(_.$$.fragment,M),M.forEach(p),this.h()},h(){document.title="Pseudocode to Python Transpiler",F(t.src,s="https://cdnjs.cloudflare.com/ajax/libs/ace/1.12.5/ace.js")||d(t,"src",s),d(t,"integrity","sha512-gLQA+KKlMRzGRNhdvGX+3F5UHojWkIIKvG2lNQk0ZM5QUbdG17/hDobp06zXMthrJrd4U1+boOEACntTGlPjJQ=="),d(t,"crossorigin","anonymous"),d(t,"referrerpolicy","no-referrer"),F(i.src,o="https://cdnjs.cloudflare.com/ajax/libs/ace/1.12.5/theme-dracula.min.js")||d(i,"src",o),d(i,"integrity","sha512-XzFsZJNE1AU2unPycw2UaT32KTSB76GPZDWi/CkO1P3f0ctnnYHop1iFI5aIVFrArykenccug+QI629Gp+vORg=="),d(i,"crossorigin","anonymous"),d(i,"referrerpolicy","no-referrer"),F(a.src,c="https://cdnjs.cloudflare.com/ajax/libs/ace/1.12.5/mode-python.min.js")||d(a,"src",c),d(a,"integrity","sha512-W1k0SdTb7FU3nxWYkBLQVhTC8b8BU6Je3deBSnLm/dSQ956goMMnL+NYi2SXse1i7k0eUJNMNycTvbEdrJmEFw=="),d(a,"crossorigin","anonymous"),d(a,"referrerpolicy","no-referrer"),d(G,"id","pseudoEditor"),d(G,"class","svelte-tt2367"),d(V,"id","pythonEditor"),d(V,"class","svelte-tt2367"),d(m,"class","svelte-tt2367")},m(g,O){h(document.head,e),h(e,r),h(document.head,t),h(document.head,i),h(document.head,a),S(g,f,O),W(u,g,O),S(g,v,O),S(g,m,O),W(w,m,null),h(m,x),h(m,G),h(m,A),h(m,V),h(m,k),W(_,m,null),y=!0},p:R,i(g){y||(j(u.$$.fragment,g),j(w.$$.fragment,g),j(_.$$.fragment,g),y=!0)},o(g){Q(u.$$.fragment,g),Q(w.$$.fragment,g),Q(_.$$.fragment,g),y=!1},d(g){p(e),p(t),p(i),p(a),g&&p(f),K(u,g),g&&p(v),g&&p(m),K(w),K(_)}}}function qe(n,e,r){let t,s;ee(n,L,u=>r(5,t=u)),ee(n,ve,u=>r(6,s=u));let i,o;$e(()=>{i=ace.edit("pseudoEditor"),i.setTheme("ace/theme/dracula"),i.session.setTabSize(2),i.setFontSize(16),i.resize(),i.setValue(""),o=ace.edit("pythonEditor"),o.setTheme("ace/theme/dracula"),o.session.setMode("ace/mode/python"),o.session.setTabSize(2),o.setFontSize(16),o.resize()});function a(){i.setValue(s)}function c(){L.update(u=>u=u==!1),console.log(t)}function f(){const v=i.getValue().split(`
`).map(x=>["pseudo",x.search(/\S|$/),x.trim()]),w=Ye(v).map(x=>{let G=x[1],A=x[2];return`${" ".repeat(G)}${A}`});o.setValue(w.join(`
`),-1)}return[a,c,f]}class De extends q{constructor(e){super(),Z(this,e,qe,Le,I,{})}}export{De as default};
