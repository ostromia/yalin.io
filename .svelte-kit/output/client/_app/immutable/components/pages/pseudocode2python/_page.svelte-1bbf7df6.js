var me=Object.defineProperty;var ge=(t,e,n)=>e in t?me(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var re=(t,e,n)=>(ge(t,typeof e!="symbol"?e+"":e,n),n);import{S as K,i as W,s as Y,k as _,q as B,a as x,l as v,m as b,r as E,h as m,c as w,n as f,b as A,G as h,L,u as ue,B as M,T as $e,H as q,U as ye,I,e as ie,M as _e,w as Q,x as T,y as H,f as J,t as j,z as U,o as ve}from"../../../chunks/index-28fc0cfa.js";import{w as fe}from"../../../chunks/index-510c38f7.js";const F=fe(!1),be=fe(`// 2020 Sample assessment materials J277/02
...
`).map(n=>[!1,n.search(/\S|$/),n.trim()])}validate(){let e=je(this.pseudocode);return e===!0?"":e}transpile(){return He(this.pseudocode).map(n=>`${" ".repeat(n[1])}${n[2]}`)}}function ze(t){let e,n,s,r,o,i,l,c,g,p,P,$,O;return e=new we({}),e.$on("vPPP",t[1]),e.$on("vPG",t[2]),e.$on("cPTP",t[3]),r=new oe({props:{style:"grid-column: 1; grid-row: 1",text:"Pseudocode",src:"ocr-logo.svg"}}),i=new oe({props:{style:"grid-column: 2; grid-row: 1",text:t[0]?"Python":"Pseudocode Guide",src:t[0]?"devicon/python-original.svg":"ocr-logo.svg"}}),$=new Ce({}),{c(){Q(e.$$.fragment),n=x(),s=_("main"),Q(r.$$.fragment),o=x(),Q(i.$$.fragment),l=x(),c=_("div"),g=x(),p=_("div"),P=x(),Q($.$$.fragment),this.h()},l(u){T(e.$$.fragment,u),n=w(u),s=v(u,"MAIN",{class:!0});var d=b(s);T(r.$$.fragment,d),o=w(d),T(i.$$.fragment,d),l=w(d),c=v(d,"DIV",{id:!0,class:!0}),b(c).forEach(m),g=w(d),p=v(d,"DIV",{id:!0,class:!0}),b(p).forEach(m),P=w(d),T($.$$.fragment,d),d.forEach(m),this.h()},h(){f(c,"id","pseudoEditor"),f(c,"class","svelte-1h6cy83"),f(p,"id","pythonEditor"),f(p,"class","svelte-1h6cy83"),f(s,"class","svelte-1h6cy83")},m(u,d){H(e,u,d),A(u,n,d),A(u,s,d),H(r,s,null),h(s,o),H(i,s,null),h(s,l),h(s,c),h(s,g),h(s,p),h(s,P),H($,s,null),O=!0},p(u,[d]){const V={};d&1&&(V.text=u[0]?"Python":"Pseudocode Guide"),d&1&&(V.src=u[0]?"devicon/python-original.svg":"ocr-logo.svg"),i.$set(V)},i(u){O||(J(e.$$.fragment,u),J(r.$$.fragment,u),J(i.$$.fragment,u),J($.$$.fragment,u),O=!0)},o(u){j(e.$$.fragment,u),j(r.$$.fragment,u),j(i.$$.fragment,u),j($.$$.fragment,u),O=!1},d(u){U(e,u),u&&m(n),u&&m(s),U(r),U(i),U($)}}}function qe(t,e,n){let s,r;q(t,be,p=>n(6,s=p)),q(t,F,p=>n(0,r=p));let o,i;ve(()=>{function p(P){P.setTheme("ace/theme/dracula"),P.setFontSize(16),P.resize()}o=ace.edit("pseudoEditor"),p(o),i=ace.edit("pythonEditor"),p(i),i.setReadOnly(!0)});function l(){o.setValue(s,1)}function c(){F.update(p=>p=!p)}function g(){const p=new Ue(o.getValue());p.validate()===""?(i.session.setMode("ace/mode/python"),i.setValue(p.transpile().join(`
`)+`
