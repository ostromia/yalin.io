import{S as mt,i as ut,s as vt,k as i,q as o,a as m,l,m as r,r as a,h as n,c as u,n as s,L as Oe,b as ft,G as e,H as ae,p as Ut,y as zt,z as Ft,A as Ht,g as Nt,d as Jt,B as Qt}from"../chunks/index.babde2ef.js";import"../chunks/paths.80ea2ab2.js";/* empty css                      */const Xt=""+new URL("../assets/knight.7c95888c.png",import.meta.url).href;function Yt(De){let t,d,I,k,h,O,f,C,b,p,D,ie,P,U,T,$,z,w,B,j,F,H,N,J,E,le,Q,_,X,Y,v,Z,A;return{c(){t=i("div"),d=i("a"),I=o("Leet Code 688."),k=m(),h=i("div"),O=o("On an "),f=i("code"),C=o("n x n"),b=o(" chessboard, a knight starts at the cell "),p=i("code"),D=o("(row, column)"),ie=o(" and attempts to make exactly "),P=i("code"),U=o("k"),T=o(` moves.
