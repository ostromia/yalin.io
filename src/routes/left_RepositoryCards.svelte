<script lang="ts">
  ...
  const cssThemeVariables = `--background-color: ${theme.backgroundColor}; --color: ${theme.color}; --link-color: ${theme.linkColor}; --language-color: ${theme.languageColor}`;
</script>
