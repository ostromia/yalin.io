<script lang="ts">
  ...
  const route_p2p: string = process.env.NODE_ENV === "production" ? "/berkay-yalin.io/pseudocode2python.html" : "/pseudocode2python";
  const route_pi: string = process.env.NODE_ENV === "production" ? "/berkay-yalin.io/pythonInterpreter.html" : "/pythonInterpreter";
...
<div id="project-container">
  <div>
    ...
    <div id="image_container">
        <!-- <a href="{route_}/pseudocode2python"> -->
        <a href={route_p2p}>
          <img alt="" id="image_p2p" src="Web capture_17-10-2022_05026_berkay-yalin.github.io.jpeg">
        </a>

        <!-- <a href="{route_}/pythonInterpreter"> -->
        <a href={route_pi}>
          <img alt="" id="image_pi" src="Web capture_17-10-2022_05345_berkay-yalin.github.io.jpeg">
        </a>
    </div>
  </div>
</div>
