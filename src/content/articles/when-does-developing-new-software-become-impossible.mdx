...
To think back to The Chromium Project, even if you someone figured out how to develop a modern browser, which according to Devault would be impossible, to try and compete with the ecosystem of extensions built around Chromium would be practically **impossible**.
