...
If we consider the knight starts within a red $(4, 4)$ board, and only has 1 move, then only will 3 out of the 8 possible moves keep the knight within the board.
...
<div style="display: flex; flex-direction: column; gap: 1rem; margin: 1rem; box-sizing: border-box;">
