...
*The following page includes the definitions of the gamma functions and their relations to each other.
These functions were particularly useful in the development of [promethium](https://github.com/berkay-yalin/promethium).*
