...
import knight_m0 from "./knight_m0.png";
import knight_m1 from "./knight_m1.png";
import knight_m2 from "./knight_m2.png";
import knight_m3 from "./knight_m3.png";
...
<Image alt="" src={knight} style="height: 300px; width: 300px; margin: auto;" />
...
<Image alt="" src={knight_m0} style="height: 400px; width: 400px; margin: auto;" />
...
<Image alt="" src={knight_m1} style="height: 400px; width: 400px; margin: auto;" />

`(0.125 * 1) + (0.125 * 1) + (0.125 * 1) + (0.125 * 0) + (0.125 * 0) + (0.125 * 0) + (0.125 * 0) + (0.125 * 0) = 0.375`

<Image alt="" src={knight_m2} style="height: 400px; width: 400px; margin: auto;" />

`(0.125 * 1) + (0.125 * 1) + (0.125 * 1) + (0.125 * 1) + (0.125 * 0) + (0.125 * 0) + (0.125 * 0) + (0.125 * 0) = 0.5`

<Image alt="" src={knight_m3} style="height: 400px; width: 400px; margin: auto;" />
